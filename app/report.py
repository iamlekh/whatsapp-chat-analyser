...
def report(filepath):
    try:
        a = data.details(filepath)
    except Exception as e:
        pass
    
    report_name = filepath.rsplit("/")[-1].split('.')[0]
    report_path = "./static/pdf/"
    ...
    def create_analytics_report(day=today_date, filename=report_path+report_name+'.pdf'):
        ...
        ''' First Page '''
        pdf.add_page()
        pdf.image("format.png", 0, 0, WIDTH)
        ...
        pdf.ln(7)
        pdf.write(1,a[12], 0)
        pdf.image("temp/activity_wrt_time.png", x = 2, y = 120, w = 206, h = 170, type = '', link = '')
        ...
        pdf.image("temp/top_active_member.png", x = 2, y = 80, w = 206, h = 170, type = '', link = '')
        
        #3
        pdf.add_page()
        pdf.image("temp/timeseries_masg_count.png", x = 2, y = 20, w = 206, h = 140, type = '', link = '')
        pdf.image("temp/top_busy_days.png", x = 2, y = 170, w = 206, h = 100, type = '', link = '')
        #4
        pdf.add_page()
        pdf.ln(15)
        ...
        pdf.image("temp/top_media_member.png", x = 2, y = 80, w = 206, h = 170, type = '', link = '')
        #5
        pdf.add_page()
        pdf.ln(5)
        ...
        pdf.image("temp/top_used_words.png", x = 2, y = 150, w = WIDTH-4, h = HEIGHT-160, type = '', link = '')
        ...
        pdf.write(10,a[14],0)
        pdf.image("temp/sentiment.png", x = 2, y = 80, w = 206, h = 170, type = '', link = '')
        #7
        pdf.add_page()
        pdf.image("temp/word_cloud.png", x = 2, y = 2, w = WIDTH-4, h = HEIGHT-4, type = '', link = '')
